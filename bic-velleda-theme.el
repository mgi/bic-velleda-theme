...
(defun bic-velleda-set (fg bg ml-active ml-inactive)
  (let ((class '((class color) (min-colors 89)))
    ...
    (custom-theme-set-faces
     ...
     `(gnus-group-news-1 ((,class (:weight bold :foreground ,turquoise))))
     `(gnus-group-news-1-empty ((,class (:foreground ,turquoise))))
     `(gnus-group-news-2 ((,class (:weight bold :foreground ,turquoise))))
     `(gnus-group-news-2-empty ((,class (:foreground ,turquoise))))
     `(gnus-group-news-3 ((,class (:weight bold :foreground ,turquoise))))
     `(gnus-group-news-3-empty ((,class (:foreground ,turquoise))))
     `(gnus-group-news-4 ((,class (:weight bold :foreground ,turquoise))))
     `(gnus-group-news-4-empty ((,class (:foreground ,turquoise))))
     `(gnus-group-news-5 ((,class (:weight bold :foreground ,turquoise))))
     `(gnus-group-news-5-empty ((,class (:foreground ,turquoise))))
     `(gnus-group-news-6 ((,class (:weight bold :foreground ,turquoise))))
     `(gnus-group-news-6-empty ((,class (:foreground ,turquoise))))
     `(gnus-group-news-low ((,class (:weight bold :foreground ,turquoise))))
     `(gnus-group-news-low-empty ((,class (:foreground ,turquoise))))
     `(gnus-group-mail-news-empty ((,class (:foreground ,blue :strike-through t))))
     `(gnus-group-mail-1 ((,class (:weight bold :foreground ,red))))
     `(gnus-group-mail-1-empty ((,class (:foreground ,red))))
     `(gnus-group-mail-2 ((,class (:weight bold :foreground ,blue))))
     `(gnus-group-mail-2-empty ((,class (:foreground ,blue))))
     `(gnus-group-mail-3 ((,class (:weight bold :foreground ,blue))))
     `(gnus-group-mail-3-empty ((,class (:foreground ,blue))))
     `(gnus-group-mail-low ((,class (:weight bold :foreground ,blue))))
     `(gnus-group-mail-low-empty ((,class (:foreground ,blue :strike-through t))))
